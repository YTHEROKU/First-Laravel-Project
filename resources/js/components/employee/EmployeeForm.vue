				...
				<div>
					...
					<el-row :guuter="10">
						<el-form-item label="Name" required prop="name"> 
							<el-input v-model="form.name" :readonly="readOnlyField" aria-placeholder="Employee Name"></el-input>
						</el-form-item>
						<el-form-item label="Department" required prop="department"> 
							<el-input v-model="form.department" :readonly="readOnlyField" aria-placeholder="Employee Department"></el-input>
						</el-form-item>
						<el-form-item label="Section" required prop="section"> 
							<el-input v-model="form.section" :readonly="readOnlyField" aria-placeholder="Employee Section"></el-input>
						</el-form-item>
						<el-form-item label="Email" required prop="email"> 
							<el-input v-model="form.email" :readonly="readOnlyField" aria-placeholder="Employee Email"></el-input>
						</el-form-item>
					</el-row>
